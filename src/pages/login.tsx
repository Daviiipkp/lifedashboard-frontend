  ...
  return (
      <div className="w-full h-screen flex flex-col items-center justify-center">
        <div className="w-[90%] max-w-sm md:max-w-md lg:max-w-md p-5 bg-gray-700 flex-col flex items-center gap-3 rounded-xl shadow-2xl shadow-blue-500/20">
              <TextLogo />
              <p className="text-xs md:text-sm text-gray-500 text-center">Dont have an account? <span className="text-white cursor-pointer" onClick={() => navigate("/register")}>Sign up</span></p>
          ...
          <p className="text 3x1 pt-5 text-gray-400 cursor-pointer">Forgot password?</p>
